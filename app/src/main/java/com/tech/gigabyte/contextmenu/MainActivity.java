...
public class MainActivity extends AppCompatActivity {
    ...
    private void doOptionOne() {
        Toast.makeText(this, "Copy Action Chosen...", Toast.LENGTH_LONG).show();
    }

    private void doOptionTwo() {
        Toast.makeText(this, "Share Action Chosen...", Toast.LENGTH_LONG).show();
    }

    private void doOptionThree() {
        Toast.makeText(this, "Cut Action Chosen...", Toast.LENGTH_LONG).show();
    }
}